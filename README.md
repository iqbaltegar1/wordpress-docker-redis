...
Berikut adalah screenshot yang WAJIB dilampirkan (letakkan file gambar di folder `screenshots/`):

1. Halaman Instalasi WordPress
   ![01 - Instalasi WordPress](screenshots/Screenshot 2026-03-27 194200.png)
2. Dashboard WordPress
   ![02 - Dashboard WordPress](screenshots/Screenshot 2026-03-27 221050.png)
3. Hasil Perintah `docker ps` (3 container aktif)
   ![03 - Hasil Perintah `docker ps`](screenshots/Screenshot 2026-03-27 201150.png)
4. Status Redis di WordPress (Connected)
   ![04 - Publis Pos](screenshots/Screenshot 2026-03-27 194742.png)
5. Redis Docker ps (`PONG`)
   ![05 - menampilkan daftar container Docker yang sedang berjalan](screenshots/Screenshot 2026-03-27 201150.png)
6. Redis CLI (`PONG`)
   ![06 - Redis Object Cacahe](5. Redis CLI (`PONG`)
   ![06 - Redis Object Cacahe](screenshots/Screenshot 2026-03-27 201150.png).png)
7. Status Redis di WordPress (Connected) (`PONG`)
   ![07 - Status Redis di WordPress (Connected)](screenshots/Screenshot 2026-03-27 202003.png)
   Status Redis di WordPress (Connected)
