...
1. Halaman Instalasi WordPress
   ![Instalasi WordPress](screenshots/Screenshot 2026-03-27 194200.png)
2. Dashboard WordPress
   ![Dashboard WordPress](screenshots/Screenshot 2026-03-27 221050.png)
3. Hasil Perintah `docker ps` (3 container aktif)
   ![docker ps - 3 Container](screenshots/Screenshot 2026-03-27 201150.png)
4. Publikasi Post di WordPress
   ![Publikasi Post](screenshots/Screenshot 2026-03-27 194742.png)
5. Redis CLI (`PONG`)
   ![Redis CLI PONG](screenshots/Screenshot 2026-03-27 202003.png)
6. Tampilan Redis di Dashboard WordPress (Connected)
   ![Redis Dashboard Connected](screenshots/Screenshot 2026-03-27 194212.png)
7. Contoh lain (opsional, jika ada):
   ![Contoh Lain](screenshots/Screenshot 2026-03-27 195831.png)
...
<table>
   <tr>
      <td align="center" width="120">
         <img src="https://avatars.githubusercontent.com/iqbaltegar1" width="100" style="border-radius:50%"><br/>
         <b>Iqbal Tegar Pratama</b>
      </td>
      <td>
         <ul>
