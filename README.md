...
1. Halaman Instalasi WordPress
   ![01 - Instalasi WordPress](screenshots/01-instalasi-wordpress.png)
2. Dashboard WordPress
   ![02 - Dashboard WordPress](screenshots/02-dashboard-wordpress.png)
3. Hasil Perintah `docker ps` (3 container aktif)
   ![03 - Docker PS 3 Container](screenshots/03-docker-ps.png)
4. Status Redis di WordPress (Connected)
   ![04 - Redis Status Connected](screenshots/04-redis-status.png)
5. Redis CLI (`PONG`)
   ![05 - Redis CLI PONG](screenshots/05-redis-cli-pong.png)
