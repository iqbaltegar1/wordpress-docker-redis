...
Tambahkan screenshot berikut (contoh penempatan gambar):

1. Halaman instalasi WordPress
   ![Instalasi WordPress](screenshots/1-instalasi-wordpress.png)
2. Dashboard WordPress
   ![Dashboard WordPress](screenshots/2-dashboard-wordpress.png)
3. Hasil `docker ps` (3 container running)
   ![docker ps](screenshots/3-docker-ps.png)
4. Redis status (Connected)
   ![Redis Status](screenshots/4-redis-status.png)
5. Redis CLI (`PONG`)
   ![Redis CLI PONG](screenshots/5-redis-cli-pong.png)
